...
def generate_qrc_file() -> int:
    from qt_quick_python_template.const import app_const, path_const  # pylint: disable=import-outside-toplevel
    from qt_quick_python_tools import deploy_env  # pylint: disable=import-outside-toplevel
...
def compile_qrc_file() -> int:
    ...
    command = f"{pyside6_rcc_executable} {QRC_FILE_NAME} > src/qt_quick_python_template/{PY_RC_FILE_NAME}"
